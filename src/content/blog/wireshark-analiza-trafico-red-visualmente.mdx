...
Si directamente no ves tráfico de vuelta del servidor (ni un SYN-ACK, ni un reset), antes de seguir investigando en la aplicación revisa si el problema es más simple: una regla de [firewall con firewalld o nftables](/blog/firewalld-nftables-seguridad-red-linux/) bloqueando el puerto silenciosamente.
