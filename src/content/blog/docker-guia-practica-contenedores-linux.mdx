...
> [!NOTE]
> Desde 2023 el comando es `docker compose` (plugin integrado en Docker Engine), no `docker-compose` con guion — esa versión en Python (Compose V1) dejó de recibir soporte en mayo de 2024. Si ves tutoriales con guion, están desactualizados.
