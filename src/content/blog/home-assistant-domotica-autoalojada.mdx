...
Si lo que te preocupa es exponer el panel de control de tu casa directamente a internet, la alternativa más prudente es no exponerlo en absoluto: monta una [VPN con WireGuard](/blog/wireguard-vpn-autoalojada/) y accede a Home Assistant como si estuvieras en tu red local, sin abrir ningún puerto hacia fuera.
