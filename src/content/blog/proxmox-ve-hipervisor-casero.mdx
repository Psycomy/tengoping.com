...
<Figure
  src="/images/blog/proxmox-ve-hipervisor-casero/proxmox-datacenter.webp"
  alt="Vista Datacenter de Proxmox VE con el nodo, sus VMs/LXC y el almacenamiento configurado (nombres de VM ocultos)"
  caption="Vista 'Datacenter' de Proxmox VE: nodo, máquinas virtuales, contenedores y almacenamiento de un homelab real (nombres de VM difuminados por privacidad)."
/>
