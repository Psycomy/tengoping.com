...
tags: ['Uptime Kuma', 'Monitorización', 'Self-Hosting', 'Disponibilidad']
...
<Figure
  src="/images/blog/uptime-kuma-monitorizar-servicios-web/uptime-kuma-dashboard.webp"
  alt="Dashboard de Uptime Kuma mostrando tres monitores: dos servicios funcionales y uno caído, con el historial de eventos"
  caption="Dashboard de Uptime Kuma: estado en tiempo real de los monitores y registro de eventos."
/>
